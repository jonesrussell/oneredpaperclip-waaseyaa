...
const ArticleController = { trashed, bulkRestore, bulkForceDelete, restore, forceDelete, bulkDelete, bulkPublish, bulkUnpublish, togglePublish, searchAssociatable, index, create, store, show, edit, update, destroy }
