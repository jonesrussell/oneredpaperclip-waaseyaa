...
/**
* @see \App\Http\Controllers\Api\OfferApiController::store
* @see app/Http/Controllers/Api/OfferApiController.php:19
* @route '/api/challenges/{challenge}/offers'
*/
...
store.definition = {
    methods: ["post"],
    url: '/api/challenges/{challenge}/offers',
