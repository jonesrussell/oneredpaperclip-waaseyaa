...
/**
* @see \App\Http\Controllers\OfferController::accept
* @see app/Http/Controllers/OfferController.php:29
* @route '/offers/{offer}/accept'
*/
...
/**
* @see \App\Http\Controllers\OfferController::decline
* @see app/Http/Controllers/OfferController.php:42
* @route '/offers/{offer}/decline'
*/
